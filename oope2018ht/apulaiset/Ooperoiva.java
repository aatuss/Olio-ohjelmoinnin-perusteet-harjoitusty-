...
/**
  * Pakolliset uudet listaoperaatiot määrittelevä geneerinen rajapinta. Kiinnit�
...
public interface Ooperoiva<T> {
   ...
   /** Tutkii onko listalla haettavaa oliota equals-mielessä vastaava alkio.     
     ...
     * vastaavia alkioita. Operaatio ei muuta listan sisältlöä millään tavalla.
     *
